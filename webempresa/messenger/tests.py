...
class ThreadTestCase(TestCase):
    def setUp(self):
        self.user1 = User.objects.create_user('user1', None, 'test12345678')
        self.user2 = User.objects.create_user('user2', None, 'test12345678')
        self.user3 = User.objects.create_user('user3', None, 'test12345678')
    ...
    def test_add_message_to_thread(self):
        ...
        message2 = Message.objects.create(user=self.user2, content="muy buenas")
    ...
    def test_add_message_from_user_not_in_thread(self):
        self.thread.users.add(self.user1, self.user2)
        message1 = Message.objects.create(user=self.user1, content="muy buenas")
        message2 = Message.objects.create(user=self.user2, content="muy bine nomas")
        message3 = Message.objects.create(user=self.user3, content="intruso")
