...
class UserCreationFormWithEmail(UserCreationForm):
    ...
    def clean_email(self):
         ...
         if User.objects.filter(email=email).exists():
             raise forms.ValidationError("ESTE EMAIL YA ESTA SIENDO UTILIZADO POR UN USUARIO")
         return email
...
class ProfileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'link': forms.Textarea(attrs={'class': 'form-control mt-3', 'rows': 3, 'placeholder': 'Enlace'}),
